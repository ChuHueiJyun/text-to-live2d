...
export class CubismModel {
  ...
  public getParameterParName(parameterIndex: number): any {
    return this._model.parameters.ids[parameterIndex];
  }
  /**
   * パラメータの値の取得
   * @param parameterIndex    パラメータのインデックス
  ...
  public loadParameters(): void {
    ...
    const savedParameterCount: number = this._savedParameters.getSize();
    /* console.log(this._savedParameters)
  ...
  public initialize(): void {
    ...
    /* window["getModelInformation"](this._model.parameters.ids, [this._model.parameters.maximumValues, this._model.parameters.values, this._model.parameters.minimumValues],function(name, value){
